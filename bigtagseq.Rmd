...
count(hip_resOrdered_df_2$pvalue < .05)
...
#write.csv(hippo_DEGs$ensemblid, "hippo_DEGs.csv", row.names = FALSE)
...
esr1graph <- ggboxplot(esr1, "sex", "count",
               color = "treatment", 
               add = "jitter",
               main = "Esr1 Normalized Counts",
               palette = "jco") 
